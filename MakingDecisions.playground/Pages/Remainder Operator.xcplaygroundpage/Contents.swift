...
// The main take away from this page is that functions can be used to make specific things and many things happen all at once such as a funciton that will let the user know whether or not they can rock on with all their equipment or if its too heavy for them to take. Not only that but the modulus is used to find a remainding amount 
